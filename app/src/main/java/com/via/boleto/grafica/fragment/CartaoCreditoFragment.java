...
public class CartaoCreditoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (GraficaUtils.verificaConexao(getActivity())){
            ...
            new BaseLocalDAO(getContext()).apagarConteudoTabela("valorCredito");
            sendRequestCredito();
            TextView textView = (TextView)view.findViewById(R.id.txt_vlrCartaoCredito);

        }else{
            TextView textView = (TextView)view.findViewById(R.id.txt_vlrCartaoCredito);
            textView.setText("R$ " + new BaseLocalDAO(getContext()).getValorCredito("valorCredito"));
        }
        ...
        call.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                if (code == 200){
                    ...
                    String valorCredito = response.body().toString().substring(7, 12);
                    new SharedPref().setLogin(getActivity(), "valorCredito", valorCredito);
                    TextView textView = (TextView)view.findViewById(R.id.txt_vlrCartaoCredito);
                    textView.setText("R$ " + new SharedPref().getLogin(getActivity(), "valorCredito"));
                    new BaseLocalDAO(getContext()).salvarVlrCredito(new SharedPref().getLogin(getActivity(), "valorCredito"));
                }
            }
